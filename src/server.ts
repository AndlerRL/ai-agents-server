  ...
  .get(
    ...
    async ({
      ...
      getServerStats: () => {
        ...
        errorRate: number;
        uptime: number;
        features: { openaiEnabled: boolean; debugMode: boolean };
      };
    }) => {
          ...
          .post(
            ...
            },
            {
              detail: {
                ...
                summary: 'Create flow',
                description:
                  'Create a new agentic flow: Name > SDK > Mediator > Agents > Tools > Trigger/Output',
              },
            }
          )
      )
        ...
        app
          ...
          .post(
            ...
            async ({ body }: { body: Record<string, unknown> }) => {
              ...
              const { name, description, role, goal, model, tools } = body as {
                name: string;
                description?: string;
                role: string;
                goal: string;
    ...
    app
      ...
      .group('/agents', (app) =>
        app
          .get(
            '/',
            ({ getAllAgents }: { getAllAgents: () => unknown[] }) => {
              return {
                success: true,
                data: getAllAgents(),
              };
            },
            {
              detail: {
                ...
                description:
                  'Retrieve all OpenAI agents with their current status and configuration',
              },
            }
          )
          ...
          .post(
            ...
            },
            {
              detail: {
                ...
                description:
                  'Create a new OpenAI agent with specified configuration',
                body: {
                  type: 'object',
                  properties: {
        ...
        app.post(
          ...
          async ({
            ...
            chatWithAgent: (
              ...
              messages: unknown[],
              options: unknown
            ) => Promise<{ metadata: { tokensUsed: number } }>;
          ...
          },
          {
            detail: {
              ...
              description:
                'Generate chat completions using OpenAI models with agent context',
              body: {
  ...
  app
    ...
    .group('/documents', (app) =>
      app
        ...
        .post('/batch', async ({ body }: { body: Record<string, unknown> }) => {
          try {
            if (!ragService) {
              return { success: false, error: 'RAG system not initialized' };
            }
...
app.group('/api/mcp', (app) =>
  app.use(mcpRoutes.decorate('mcpManager', mcpManager))
);
...
app = app
  ...
  .get('/dashboard', getDashboardDataHandler, {
    detail: {
      ...
      description:
        'Alternative route to access the server-side rendered React dashboard',
    },
  });
